...
# Enter: test_auth_token_xxxxxxxxxxxx
...
```bash
curl https://test-email-to-sms.test.example.com/health
```
...
Generated by security-validation-test on 2025-11-14T02:12:30.082383Z