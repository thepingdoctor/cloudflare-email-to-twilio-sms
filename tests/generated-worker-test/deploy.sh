#!/bin/bash
# Deployment script for security-test-worker
# Generated by: email-to-sms-streamlit-generator

set -e

echo "🚀 Deploying security-test-worker..."
...
echo ""
echo "🔗 Worker URL: https://security-test-worker.test.example.com"
echo "🏥 Health check: https://security-test-worker.test.example.com/health"
echo ""